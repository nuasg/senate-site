if window.location.pathname.startsWith("/display")
  App.vote_display = App.cable.subscriptions.create "VotingChannel",
    connected: ->
      console.log('vote_display channel connected')
    ...
    receive_vote: (affiliation, vote, old_vote) ->
      ...
      old_bar.style.height = (x * 100 / @total_votes()) + "%" if old_bar
